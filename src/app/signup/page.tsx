  ...
  return (
    <div className='relative mx-auto flex h-[calc(100vh-64px)] min-h-[600px] w-full max-w-7xl items-center justify-center overflow-hidden md:min-h-[780px]'>
      <Container className='max-w-[420px]'>
        <div className='flex w-full flex-col items-center justify-center gap-6 rounded-xl bg-red-200 px-10 pb-12 pt-8'>
      ...
      <div className='absolute inset-0 left-[60px] -z-[1] hidden h-full overflow-hidden bg-signup-pattern bg-cover bg-center bg-no-repeat md:block' />
    </div>
  );
}
